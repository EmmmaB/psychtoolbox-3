...
fprintf('support for MacOSX and 64-Bit support for Matlab on Microsoft Windows.\n\n');
...
fprintf('than V7.4, aka R2007a. Support for 32-Bit Octave on OSX has been removed.\n');
fprintf('Support for Octave on MS-Windows has been completely removed. Support for\n');
fprintf('Apple Quicktime on MS-Windows is gone as well - GStreamer is now mandatory for\n');
fprintf('multi-media functionality. Various other legacy features will also get removed.\n');
fprintf('\n');
